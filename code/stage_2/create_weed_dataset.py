...
def m_args():
    ...
    parser.add_argument('--dataset_path', type=str, default='/media/mulham/4AA6CD64A6CD515D/plants_dataset/SugarBeets_256/', help='Dataset path')
...
#    args = parseArgs()
    ...
    output_path ='/media/mulham/4AA6CD64A6CD515D/CKA_160517/annotations/dlp/output_example/test/' # #'../../dataset/Segmentation/'
    ...
    if False:
        ...
        # Generate data
        generate_dataset(path='/media/mulham/4AA6CD64A6CD515D/test_dataset', output_path=output_path, annotation_path='/media/mulham/4AA6CD64A6CD515D/CKA_160517/annotations/dlp/', background=False, blur=True)
