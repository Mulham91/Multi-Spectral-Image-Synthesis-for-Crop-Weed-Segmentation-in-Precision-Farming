...
#        gpu_device = '/cpu:0'
        ...
        img_and_segmap = img_and_segmap.apply(shuffle_and_repeat(self.dataset_num)).apply(
            map_and_batch(self.img_class.image_processing, self.batch_size, num_parallel_batches=1,
    ...
    def train(self):
        ...
        if could_load:
            ...
            batch_id = start_epoch * self.iterationget_images
            print(" [*] Load SUCCESS")
        else:
            start_epoch = 0
            batch_id = 0
    ...
    def guide_test(self):
        ...
        for style in style_files:
            ...
            for sample_file in segmap_files:
                ...
                index.write(    gan.load_model()    gan.load_model()    gan.load_model()
