                    ...
                    if len(radius_list) > 0:
                        for fold in range(1):
                            ...
                            for [m_x, m_y, stem_x, stem_y, radius, cropMask, cropMaskResized] in radius_list:
                                ...
                                cv2.imwrite(output_path + 'train/original/image_' + str(imageNumber) +'synthetic_rgb'+ '_' + str(i) + '.png',synthetic_rgb)
                                cv2.imwrite(output_path + 'train/original/image_' + str(imageNumber) +'synthetic_nir'+ '_' + str(i) + '.png',synthetic_nir)
                               ...
                               # synthetic_rgb = np.repeat(synthetic_rgb, 3, axis=2)
                                ...
                                if not background:
                                    ...
                                    cv2.imwrite(output_path + 'train/original/image_' + str(imageNumber) +'_original_nir'+ '_' + str(fold) + '.png',original_nir)
